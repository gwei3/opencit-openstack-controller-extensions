...
class HVMetadataNotFound(NotFound):
    msg_fmt = _("Hypervisor metadata for host %(host)s could not be found.")

class HVMetadataExists(NovaException):
    msg_fmt = _("Hypervisor metadata for %(name)s already exists.")
